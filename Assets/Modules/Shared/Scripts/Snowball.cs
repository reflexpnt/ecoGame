...
namespace Niantic.ARVoyage
{
    ...
    public class Snowball : MonoBehaviour
    {
        ...
        public string TipoDiImmondizia = "";
        public GameObject SnowballTossManager;
        [Header("VFX")]
        ...
        public void Awake()
        {
            ...
            ShowVFX(false);
            SnowballTossManager= GameObject.Find("SnowballTossManager"); 
        }
        ...
        {
            if (collision.gameObject.name == "CollBidone" 
                && collision.gameObject.transform.parent.CompareTag( this.TipoDiImmondizia))
            
            {
               // collision.gameObject.GetComponentInParent<Renderer>().material.color = Color.white;
                SnowballTossManager.GetComponent<SnowballTossManager>().SnowRingSucceeded();
